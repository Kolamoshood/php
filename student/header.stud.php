        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <div class=" mt-2">Welcome <strong> <?php echo $matric_no ;?></strong></div>   
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-md-none topbar-head-dropdown header-item">
                    <div class=" mt-1"><strong> <?php echo $matric_no ;?></strong></div>   
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="change_pwd.php"><span
        ...
        <div class="navbar-brand-box">
            ...
            <div id="scrollbar">
                ...
                <div class="container-fluid">
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="course_reg.php"  aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-file-search-line"></i> <span data-key="t-dashboards">Course Registration</span>
                            </a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="details.php"  aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-file-search-line"></i> <span data-key="t-dashboards">Personal details</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="change_pwd.php"  aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-file-search-line"></i> <span data-key="t-dashboards">Password Management</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="payment.php"  aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-file-search-line"></i> <span data-key="t-dashboards">Payments</span>
                            </a>
                        </li>
                            ...
                            <div class="col-12 col-lg-auto order-last order-lg-0">
                                <div class="row text text-white-50 text-center">
                                    <div class="col-lg-12 col-4">
                                        <div class="p-2">
                                            <div class="dropdown topbar-head-dropdown ms-1 header-item">
                                                <button class=" btn btn-light mb-1" type = "button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Log out</button>
                                                <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                                    <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <a href="stud_logout.php" class="btn btn-danger">
                                                                       Confirm Log Out
                                                                </a>	
                                                            </div>
                                                            <div class="col-auto">
